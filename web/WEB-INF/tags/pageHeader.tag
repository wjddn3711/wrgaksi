          ...
          <div class="rd-navbar-right rd-navbar-nav-wrap">
              ...
              <ul class="list-share-2">
                ...
                <c:choose>
                  ...
                  <c:otherwise>
                    ...
                    <a href="logout.me" class="btn button-xxs button-white">로그아웃</a>
            ...
            <div class="rd-navbar-main">
              ...
              <ul class="rd-navbar-nav">
                ...
                <li class="${pageSector eq 'board' ? 'rd-nav-item active' : 'rd-nav-item'}"><a class="rd-nav-link" href="boardList.do">상품 신청</a>
                </li>
              </ul>
            </div>
          </div>
