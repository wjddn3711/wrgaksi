        ...
        <div class="col-sm-6 col-xl-4 wow fadeInUp" data-wow-delay="0s">
          <article class="box-icon-classic">
            <div class="unit unit-spacing-lg flex-column text-center flex-md-row text-md-left">
              <div class="unit-left">
                <div class="box-icon-classic-icon fas fa-truck-moving"></div>
              </div>
              <div class="unit-body">
          ...
          <article class="box-icon-classic">
            <div class="unit unit-spacing-lg flex-column text-center flex-md-row text-md-left">
              ...
              <div class="unit-body">
                ...
                <p class="box-icon-classic-text">신메뉴 연구와 고객 의견 반영에 적극 힘쓰고 있습니다.</p>
              </div>
            </div>
          </article>
        </div>
          ...
          <article class="box-icon-classic">
            <div class="unit unit-spacing-lg flex-column text-center flex-md-row text-md-left">
              ...
              <div class="unit-body">
                ...
                <p class="box-icon-classic-text">전문 영양사가 엄선한 식단을 고민없이 즐겨보세요!</p>
              </div>
            </div>
          </article>
        </div>
