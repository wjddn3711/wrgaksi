                ...
                <div class="tableWrapper6">
                    <table>
                        ...
                        <tr>
                            <td>희망 보관장소</td>
                            <td colspan="2">
                                <select style="border: 0.6px solid black;">
                ...
                <div class="tableWrapper6">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="pay" required> 핸드폰으로 결제</td>
                            <td><input type="radio" name="pay" required> 무통장 입금</td>
                        </tr>
                    </table>
                </div>

                위 주문 내용을 확인하였으며, 회원 본인은 결제에 동의합니다.<input type="checkbox" id=check required><br><br><br>
