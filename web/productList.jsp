                ...
                <div class="row row-lg row-30">
                    ...
                    <c:forEach var="v" items="${productList}">
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <article class="product wow fadeInLeft" data-wow-delay=".15s" style="border-radius: 10px;">
                                ...
                                <div class="product-button">
                                    <div class="button-wrap">
                                        <a class="button button-xs button-primary button-winona"
                                           href="productAdd.pd?product_number=${v.product_number}" style="border-radius: 20px;">장바구니에
                                            추가</a>
                                    </div>
                                    <div class="button-wrap">
                                        <a class="button button-xs button-secondary button-winona"
                                           href="productDetail.pd?product_number=${v.product_number}" style="border-radius: 20px;">상세보기</a>
                                    </div>
                                </div>
